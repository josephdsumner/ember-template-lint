...
function hasAttributeValue(node, attributeName, nodeAttributeValue, unwrapTextNode = true) {
...
function elementAttributeValue(node, attributeName, unwrapTextNode = true) {
...
function attributeValue(attrNode, unwrapTextNode = true) {
  if (!attrNode) {
    return;
  }
