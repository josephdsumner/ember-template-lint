  ...
  visitor() {
    return {
      ...
      ElementNode(node) {
        ...
        if (AstNodeInfo.hasAttributeValue(node, 'aria-hidden', 'true', true)) {
          return;
        }
        ...
        if (isImg) {
          ...
          const altValue = AstNodeInfo.elementAttributeValue(node, 'alt', true);
          const roleValue = AstNodeInfo.elementAttributeValue(node, 'role', true);
          const srcValue = AstNodeInfo.elementAttributeValue(node, 'src', true);
          ...
          const isImageInput = AstNodeInfo.hasAttributeValue(node, 'type', 'image', true);
          if (!isImageInput) {
            return;
          }
