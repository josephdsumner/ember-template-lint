...
module.exports = class NoDuplicateId extends Rule {
  visitor() {
    ...
    return {
      AttrNode(node) {
        console.log(chalk.green(`AN sourceForNode: ${this.sourceForNode(node)}`));
        // console.log(chalk.blue(util.inspect(node, { depth: null })));
        ...
        if (isMustacheString(node)) {
          console.log(chalk.yellow(this.sourceForNode(node.value)));
        ...
        console.log(chalk.blue(this.sourceForNode(idValue)));
      ...
      BlockStatement(node) {
        console.log(chalk.green(`sourceForNode: ${this.sourceForNode(node)}`));
        // console.log(chalk.blue(util.inspect(node, { depth: null })));
        // Helpers
        ...
        console.log(chalk.blue(util.inspect(elementIdHashArg, { depth: null })));
        console.log(chalk.blue(this.sourceForNode(elementIdHashArg.value)));
      ...
      MustacheStatement(node) {
        ...
        // console.log(chalk.cyan(`sourceForNode: ${this.sourceForNode(idHashArg)}`));
